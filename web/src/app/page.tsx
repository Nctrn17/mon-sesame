    ...
    <div>
      ...
      <section className="bg-brand-light">
        <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:py-24">
          ...
          <div className="mt-8">
            <Link
              href="/simulateur"
              className="inline-block rounded-xl bg-brand px-8 py-4 text-xl font-semibold text-white shadow-sm transition hover:bg-brand-dark"
            >
              Découvrir mes droits
            </Link>
          </div>
          <p className="mt-4 text-muted">Gratuit · Sans inscription · Environ 3 minutes</p>
        </div>
      </section>

      {/* Pourquoi */}
      <section className="mx-auto max-w-3xl px-4 py-16">
        <h2 className="text-3xl font-bold text-foreground">Pourquoi tant d&apos;aides passent inaperçues</h2>
        ...
        <div className="mx-auto max-w-3xl px-4 py-16">
          ...
          <ol className="mt-8 space-y-6">
            ...
            <Step n={2} title="On croise votre profil avec les aides">
              Aides nationales, de votre caisse de retraite et de votre territoire : tout est
              passé en revue.
            </Step>
          ...
          <div className="mt-10">
            <Link
              href="/simulateur"
              className="inline-block rounded-xl bg-brand px-8 py-4 text-xl font-semibold text-white hover:bg-brand-dark"
            >
      ...
      <section className="mx-auto max-w-3xl px-4 py-16">
        ...
        <ul className="mt-6 space-y-3 text-lg text-foreground">
          ...
          <Trust>Anonyme : aucune inscription obligatoire, vos réponses ne sont pas conservées.</Trust>
        ...
        <p className="mt-8 rounded-xl border border-border bg-card p-4 text-muted">

...
export const handicapDefinitions: AidDefinition[] = [
  {
    aid: {
      ...
      source: { label: "service-public.fr : CMI", url: "https://www.service-public.fr/particuliers/vosdroits/F34049" },
      howToApply: {
  ...
  },
  {
    aid: {
      ...
      source: { label: "service-public.fr : AAH", url: "https://www.service-public.fr/particuliers/vosdroits/F12242" },
      howToApply: {
  ...
  },
  {
    aid: {
      ...
      source: { label: "service-public.fr : PCH", url: "https://www.service-public.fr/particuliers/vosdroits/F14202" },
      howToApply: {
  ...
  },
  {
    aid: {
      ...
      source: { label: "service-public.fr : MTP", url: "https://www.service-public.fr/particuliers/vosdroits/F31434" },
      howToApply: {
